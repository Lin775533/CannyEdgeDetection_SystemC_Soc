	         ...
	         if(gx >= 0){
	            if(gy >= 0){
	                    if (gx >= gy)
	                    {
	                        ...
	                        mag1 = ((m00 - z1)*xperp + (z2 - z1)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr + 1);
	                        z2 = *(magptr + ncols + 1);

	                        mag2 = ((m00 - z1)*xperp + (z2 - z1)*yperp) >> 16;
	                    }
	                    else
	                    {
	                        /* 110 */
	                        ...
	                        mag1 = ((z1 - z2)*xperp + (z1 - m00)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr + ncols);
	                        z2 = *(magptr + ncols + 1);

	                        mag2 = ((z1 - z2)*xperp + (z1 - m00)*yperp) >> 16;
	                    }
	                }
	                else
	                {
	                    if (gx >= -gy)
	                    {
	                        ...
	                        mag1 = ((m00 - z1)*xperp + (z1 - z2)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr + 1);
	                        z2 = *(magptr - ncols + 1);

	                        mag2 = ((m00 - z1)*xperp + (z1 - z2)*yperp) >> 16;
	                    }
	                    else
	                    {
	                        /* 100 */
	                        ...
	                        mag1 = ((z1 - z2)*xperp + (m00 - z1)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr - ncols);
	                        z2 = *(magptr - ncols + 1);

	                        mag2 = ((z1 - z2)*xperp  + (m00 - z1)*yperp) >> 16;
	                    }
	                }
	            }
	            else
	            {
	                if ((gy = *gyptr) >= 0)
	                {
	                    if (-gx >= gy)
	                    {
	                        ...
	                        mag1 = ((z1 - m00)*xperp + (z2 - z1)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr - 1);
	                        z2 = *(magptr + ncols - 1);

	                        mag2 = ((z1 - m00)*xperp + (z2 - z1)*yperp) >> 16;
	                    }
	                    else
	                    {
	                        /* 010 */
	                        ...
	                        mag1 = ((z2 - z1)*xperp + (z1 - m00)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr + ncols);
	                        z2 = *(magptr + ncols - 1);

	                        mag2 = ((z2 - z1)*xperp + (z1 - m00)*yperp) >> 16;
	                    }
	                }
	                else
	                {
	                    if (-gx > -gy)
	                    {
	                        ...
	                        mag1 = ((z1 - m00)*xperp + (z1 - z2)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr - 1);
	                        z2 = *(magptr - ncols - 1);

	                        mag2 = ((z1 - m00)*xperp + (z1 - z2)*yperp) >> 16;
	                    }
	                    else
	                    {
	                        /* 000 */
	                        ...
	                        mag1 = ((z2 - z1)*xperp + (m00 - z1)*yperp) >> 16;

	                        /* Right point */
	                        z1 = *(magptr - ncols);
	                        z2 = *(magptr - ncols - 1);

	                        mag2 = ((z2 - z1)*xperp + (m00 - z1)*yperp) >> 16;
	                    }
	                }
	            }
